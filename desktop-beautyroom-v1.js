...
(function(){
  ...
  const desktopDetailTune2Css=document.createElement('style');
  desktopDetailTune2Css.id='esmeralda-desktop-detail-tune-v19';
  ...
  desktopLangUnderBrandCss.id='esmeralda-desktop-lang-below-brand-v31';
  ...
  const desktopLangIconCss=document.createElement('style');
...
`;
  ...
  const clientFinalCss=document.createElement('style');
  clientFinalCss.id='esmeralda-desktop-client-final-v47';
  clientFinalCss.textContent=`
@media(min-width:768px){
...
`;
  document.head.appendChild(clientFinalCss);

  /* Correct the grid row introduced by the separate right-hand title.
     The sticky left rail spans every right-hand row, including expanded services. */
  const geometryFix=document.createElement('style');
  geometryFix.id='esmeralda-desktop-geometry-fix-v48';
  geometryFix.textContent=`
...
@media(min-width:768px) and (max-width:1199px){
  ...
  #esmeraldaDesktopServices .dct-services-main-title{grid-column:2!important;grid-row:1!important;margin:0!important;padding:0!important}
  #esmeraldaDesktopServices .mct-tabs-ribbon-wrap{grid-column:2!important;grid-row:2!important;margin:30px 0 0 -.5cm!important;width:calc(100% + .5cm)!important}
  #esmeraldaDesktopServices .mct-tabs{padding-left:.5cm!important}
  #esmeraldaDesktopServices .dct-service-groups{grid-column:2!important;grid-row:3!important;margin:0!important}
...
@media(min-width:768px){
  #esmeraldaDesktopServices .mct-tab[aria-selected="true"]{
    background:#d8b7aa!important;
    border-color:#e6cabb!important;
    color:#241d19!important;
    box-shadow:0 12px 30px rgba(216,183,170,.28)!important;
  }
  #esmeraldaDesktopServices .dct-service-sticky-book{
    position:relative!important;
    overflow:hidden!important;
...
`;
    ...
    <section class="mct-about br-about-team" id="esmeraldaDesktopAbout" aria-labelledby="stdAboutTitle">
      ...
      <div class="mct-shell br-about-team-shell">
        ...
        <aside class="br-team-panel" id="esmeraldaDesktopTeam" aria-labelledby="stdTeamTitle">
          <p class="std-team-kicker">Мастера Beauty Room</p>
  ...
  const DESKTOP_I18N_ROWS=[
    ...
    ['Салон красоты в самом сердце Еревана.','Գեղեցկության սրահ Երևանի սրտում։','A beauty salon in the heart of Yerevan.'],['Листайте вниз','Սահեցրեք ներքև','Scroll down'],['Ереван,','Երևան,','Yerevan,'],['Zavarian St 1/5','Զավարյան փ. 1/5','1/5 Zavarian St'],
    ...
    ['Смотреть все отзывы →','Դիտել բոլոր կարծիքները →','View all reviews →'],['Ждём вас','Սպասում ենք ձեզ','We look forward to seeing you'],['Ереван, Zavarian St 1/5','Երևան, Զավարյան փ. 1/5','Yerevan, 1/5 Zavarian St'],
